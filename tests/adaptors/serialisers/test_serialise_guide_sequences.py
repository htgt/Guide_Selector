...
class TestWriteGuideSequencesToInputTSV(TestCase):
    ...
    def test_write_guide_sequences_to_tsv(self):
        ...
        expected = (
            'guide_id\tchr\tstart\tend\tgrna_strand\tot_summary\ttarget_region_id\n'
            '1139540371\tchr16\t67610855\t67610877\t+\t{0: 1, 1: 0, 2: 1, 3: 8, 4: 98}\t123\n'
            '1139541475\tchr16\t67620712\t67620734\t-\t{0: 1, 1: 0, 2: 0, 3: 3, 4: 69}\t321\n'
        )
